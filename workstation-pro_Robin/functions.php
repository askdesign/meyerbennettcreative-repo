...
function workstation_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Roboto:300,400,500,700', array(), CHILD_THEME_VERSION );
		//wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Source+Sans+Pro:300,300i,400,400i,600,600i,700,700i,900,900i|Lato:300,700|Roboto:300,500,700', array(), CHILD_THEME_VERSION );
...
genesis_register_sidebar( array(
	'id'          => 'front-page-0',
	'name'        => __( 'Front Page 0', 'workstation-pro' ),
	'description' => __( 'This is the front page 0 section.', 'workstation-pro' ),
) );
genesis_register_sidebar( array(
	'id'          => 'front-page-1',
...
function wpbsearchform( $form ) {
    ...
    <input style="width:50%; float:left;" type="text" value="' . get_search_query() . '" name="s" id="s" />
    <input style="margin: 0 20px 20px;" type="submit" id="searchsubmit" value="'. esc_attr__('Search') .'" />
    </div>
    </form>'; 
    return $form;
}
