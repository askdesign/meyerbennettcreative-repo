...
function workstation_front_page_genesis_meta() {
	...
	if ( is_active_sidebar( 'front-page-0' ) || is_active_sidebar( 'front-page-1' ) || is_active_sidebar( 'front-page-2' ) || is_active_sidebar( 'front-page-3' ) || is_active_sidebar( 'front-page-4' ) ) {
...
function workstation_front_page_widgets() {
	...
	genesis_widget_area( 'front-page-0', array(
		'before' => '<div id="front-page-0" class="front-page-0"><div class="widget-area wrap' . workstation_widget_area_class( 'front-page-0' ) . '">',
		'after'  => '</div></div>',
	) );
