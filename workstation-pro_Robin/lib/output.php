...
function workstation_css() {
	...
	$color_fp0    = get_theme_mod( 'workstation_front_page_0_color', workstation_customizer_get_default_front_page_0_color() );
	...
	$css .= ( workstation_customizer_get_default_accent_color() !== $color_accent ) ? sprintf( '
		...
		.front-page-0 a:focus,
		.front-page-0 a:hover,
	...
	$css .= ( workstation_customizer_get_default_front_page_0_color() !== $color_fp0 ) ? sprintf( '
		...
		.front-page-0,
		.front-page-0 a,
		.front-page-0 .widget li a {
			color: %2$s;
		}

		.front-page-0 button:focus,
		.front-page-0 button:hover,
		.front-page-0 input:focus[type="button"],
		.front-page-0 input:focus[type="reset"],
		.front-page-0 input:focus[type="submit"],
		.front-page-0 input:hover[type="button"],
		.front-page-0 input:hover[type="reset"],
		.front-page-0 input:hover[type="submit"],
		.front-page-0 .button:focus,
		.front-page-0 .button:hover {
			background-color: %2$s;
			color: %1$s;
		}
		', $color_fp0, workstation_color_contrast( $color_fp0 ), workstation_change_brightness( $color_fp0 ) ) : '';
