...
function workstation_customizer_register( $wp_customize ) {
	...
	$wp_customize->add_setting(
		'workstation_front_page_0_color',
		array(
			'default'           => workstation_customizer_get_default_front_page_0_color(),
			'sanitize_callback' => 'sanitize_hex_color',
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			array(
				...
				'label'       => __( 'Front Page 0 Color', 'workstation-pro' ),
				'section'     => 'colors',
				'settings'    => 'workstation_front_page_0_color',
			)
		)
	);
